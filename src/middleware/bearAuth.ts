...
//   const userId = typeof raw.userId === 'number'
//     ? raw.userId
...
//       return res.status(403).json({ error: `Role '${decoded.role}' not authorized` });
//     }

//     console.log('[authMiddleware] Authenticated:', decoded);
//     req.user = decoded;
//     next();
//   };
// };
